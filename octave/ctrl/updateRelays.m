function updateRelays()
  ...
  if adapterStruct.hasRelays
    ...
    changed |= setArdPin(ardStruct.ard, ardStruct.gndPlusPin,  adapterStruct.gndPlus, 'Relay IN+GND');
    changed |= setArdPin(ardStruct.ard, ardStruct.gndMinusPin,  adapterStruct.gndMinus, 'Relay IN-GND');
