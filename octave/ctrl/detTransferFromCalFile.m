...
function [gain, phaseShift] = detTransferFromCalFile(freq, fs, playAmpl, playChID, analysedChID, chMode, extCircuit)
  global COMP_TYPE_JOINT;
  
  peaksRow = loadCalRow(freq, fs, COMP_TYPE_JOINT, playChID, analysedChID, chMode, extCircuit);
